stopwords = open('recognizer/misc/stopwords_id.txt', 'rb').read().splitlines()

abbr_tuples = [ line.split(' = ') for line in open('recognizer/misc/abbreviations_id.txt', 'rb').read().splitlines() ]
